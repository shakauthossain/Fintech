import { iconClass } from "@/lib/cn";

type IconProps = { className?: string };

export function IconDashboard({ className }: IconProps) {
  return (
    <svg className={iconClass("h-4 w-4", className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export function IconUpload({ className }: IconProps) {
  return (
    <svg className={iconClass("h-5 w-5", className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
